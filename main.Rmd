...
source("scripts/readIEAHydrogenProjectsDatabaseWithEndUse.R")
...
legend.labels <- c("v2021" = "Announcements in 2021",
                   "v2022" = "Announcements in 2022",
                   "v2023" = "Announcements in 2023")
...
p.right <- ggplot() +
  ...
  scale_color_npg(name = "Project announcements",
                  ...
                  breaks = c("v2021",
                             "v2022",
                             "v2023"),
                  labels = c("v2021" = "Announcements in 2021",
                             "v2022" = "Announcements in 2022",
                             "v2023" = "Announcements in 2023")) +
  scale_alpha_manual(name = "Project announcements",
                     guide = guide_legend(order = 2),
...
temp <- readIEAHydrogenProjectsDBWithEndUse(
  ...
  h2projects.range.2023outcome = "A5:AG127",
  end.year = 2023,
  checked = TRUE
)
...
p.wco2 <- ggdraw() +
  draw_label(aes(label = "With carbon price"),
             size = 6,
             fontface = "bold")
...
p.total.woco2 <- ggplot() +
  ...
  scale_y_continuous(name = "Billion $/yr",
                     limits = c(ymin, ymax)) +
  ggtitle("Total annual support without carbon pricing")
...
p.total.wco2 <- ggplot() +
  ...
  scale_y_continuous(name = "Billion $/yr",
                     limits = c(ymin, ymax)) +
  ggtitle("Total annual support with carbon pricing")
...
p.relative.woco2 <- ggplot() +
  ...
  scale_x_continuous(name = "Year",
                     limits = c(2010, 2050)) +
  ylab("$/MWh") +
  ggtitle("Relative support without carbon pricing")
...
p.relative.wco2 <- ggplot() +
  ...
  scale_x_continuous(name = "Year",
                     limits = c(2010, 2050)) +
  ylab("$/MWh") +
  ggtitle("Relative support with carbon pricing")
...
bottom_row.left.title <- ggdraw() +
  draw_label(
    "Announcements in 2021 vs. outcome in 2023",
    x = 0.55,
    hjust = 0.5,
    vjust = 0,
    size = font.size
...
bottom_row.right.title <- ggdraw() +
  draw_label(
    "Announcements in 2022 vs. outcome in 2023",
    x = 0.55,
    hjust = 0.5,
    vjust = 0,
    size = font.size)
...
## SUPPLEMENRATY FIGURE S11: Project announcements and median 1.5°C scenario until 2050
...
## SUPPLEMENTARY FIGURE S13: Green hydrogen in 1.5°C scenario under IEA NZE end-use shares
...
## SUPPLEMENTARY FIGURE S16: Required subsidies for 1.5°C scenario median
...
p <- ggplot() +
  ...
  facet_grid(scenario ~ carbonprice,
             labeller = labeller(carbonprice = c("TRUE" = "With carbon price",
