...
# Read electrolysis capacity requirements in 1.5°C scenarios
...
## FIGURE 4: 1.5°C scenarios and ambition gap in 2030
...
p.scen <- ggplot() +
  ...
  geom_boxplot(data = data.scenarios.2030,
               mapping = aes(x = "Institutional", y = value.mw),
               linewidth = 0.25,
               width = 0.15) +
  geom_sina(data = data.scenarios.2030,
              mapping = aes(x = "Institutional", y = value.mw, color = highlight, group = factor("Institutional")),
            size = 1,
            alpha = 0.5,
            show.legend = FALSE) +
  ...
  scale_y_continuous(
    ...
    limits = c(0, 1080)) +
  ggtitle("Green hydrogen in 1.5°C scenarios in 2030")
...
data.plot.scenarios.range <- data.scenarios.2030 %>% 
  summarise(min = min(value.mw),
            max = max(value.mw),
            lower = quantile(value.mw, 0.25),
            upper = quantile(value.mw, 0.75),
            median = median(value.mw))
...
# From 2030 use median of 1.5°C scenario
...
# Subsidies required for 1.5°C scenario until 2050
data.subsidies.annual %>% 
...
# Specific subsidies required for 1.5°C scenario in 2050
data.subsidies.annual %>% 
  filter(year == 2050) %>% 
...
## EXTENDED DATA FIGURE 1: Electrolysis in 1.5°C scenarios
...
# Calculate required exponential growth rates for 2030 1.5°C scenarios
cap.2023 <- data.real %>% 
  filter(year == 2023) %>% 
  pull(value)
...
data.growth.inst <- data.scenarios %>% 
  filter(year == 2030) %>% 
  mutate(growth.rate = (value.mw/cap.2023)**(1/7) - 1) %>% 
  select(organisation, report, scen.name, region, value.mw, year, growth.rate) %>% 
  group_by(organisation, report, scen.name, region, growth.rate) %>% 
  complete(year = seq(2023, 2030, 0.25)) %>% 
  mutate(value.mw = cap.2023 * (1 + growth.rate)**(year - 2023))
...
p.inst.left <- ggplot() +
  ...
  geom_line(data = data.growth.inst,
            mapping = aes(x = year, y = value.mw, color = organisation, group = scen.name),
            linetype = "dotted",
            linewidth = 0.25) +
  # Institutional scenarios
  ...
  ggtitle("Institutional and corporate 1.5°C scenarios until 2030") +
...
p.inst.right <- ggplot() +
  ...
  geom_text_repel(
    data = data.label,
    mapping = aes(x = 2050.3, y = value.mw, label = scen.name, color = organisation),
    size = 5 /.pt,
    nudge_x = 4,
    hjust = 0,
    direction = "y",
  ...
  ggtitle("Institutional and corporate 1.5°C scenarios until 2050") +
  coord_cartesian(clip = "off") +
...
p.iam.left <- ggplot() +
  ...
  scale_x_continuous(name = "Year", breaks = c(2020, 2025, 2030)) +
  scale_y_continuous(name = "Capacity (GW)", limits = c(0, 1730)) +
  ggtitle("IAM 1.5°C scenarios until 2030") +
  theme(axis.line = element_blank(),
        panel.border = element_rect(color = "black", fill = NA, linewidth = 0.5))
...
p.iam.right <- ggplot() +
  ...
  scale_y_continuous(name = "Capacity (GW)",
                     limits = c(0, 7600)) +
  ggtitle("IAM 1.5°C scenarios until 2050") +
  coord_cartesian(clip = "off") +
  theme(plot.margin = unit(c(1,20,1,1), units = "mm"))
...
p.right <- ggplot() +
  ...
  geom_text_repel(
    data = data.label,
    mapping = aes(x = 2030.5, y = value.mw, label = label),
    hjust = 0,
    size = 5 /.pt,
    nudge_x = 0.55,
    direction = "y",
...
## SUPPLEMENTARY FIGURE 1: IEA data quality validation (overview)
...
ggsave("figures/SUPP_FIGURE01_database_quality_validation_overview.png",
       width = 180, height = 70, units = "mm", bg = "white", dpi = 600)
ggsave("figures/SUPP_FIGURE01_database_quality_validation_overview.svg",
       width = 180, height = 70, units = "mm", bg = "white")

```

## SUPPLEMENTARY FIGURE 2: IEA data quality validation (2021 project detail)
...
ggsave("figures/SUPP_FIGURE02_data_quality_validation_v2021.png",
       width = 180, height = 110, units = "mm", bg = "white", dpi = 600)
ggsave("figures/SUPP_FIGURE02_data_quality_validation_v2021.svg",
       width = 180, height = 110, units = "mm", bg = "white")

```

## SUPPLEMENTARY FIGURE 3: IEA data quality validation (2022 project detail)
...
ggsave("figures/SUPP_FIGURE03_data_quality_validation_v2022.png",
       width = 180, height = 110, units = "mm", bg = "white", dpi = 600)
ggsave("figures/SUPP_FIGURE03_data_quality_validation_v2022.svg",
       width = 180, height = 110, units = "mm", bg = "white")

```

## SUPPLEMENTARY FIGURE 4: IEA data quality validation (2023 project detail)
...
ggsave("figures/SUPP_FIGURE04_data_quality_validation_v2023.png",
       width = 180, height = 110, units = "mm", bg = "white", dpi = 600)
ggsave("figures/SUPP_FIGURE04_data_quality_validation_v2023.svg",
       width = 180, height = 110, units = "mm", bg = "white")

```

## SUPPLEMENTARY FIGURE 5: 2022 implementation gap
...
ggsave("figures/SUPP_FIGURE05_2022_implementation_gap.png",
       width = 180, height = 150, units = "mm", bg = "white", dpi = 600)
ggsave("figures/SUPP_FIGURE05_2022_implementation_gap.svg",
       width = 180, height = 150, units = "mm", bg = "white")

```

## SUPPLEMENTARY FIGURE 6: Project tracking for 2024
...
ggsave("figures/SUPP_FIGURE06_project_tracking_2024.png",
       width = 180, height = 100, units = "mm", bg = "white", dpi = 600)
ggsave("figures/SUPP_FIGURE06_project_tracking_2024.svg",
       width = 180, height = 100, units = "mm", bg = "white")

```

## SUPPLEMENTARY FIGURE 7-10: Regional 2023 implementation gap

```{r supplementary figure 7-10}
...
ggsave("figures/SUPP_FIGURE07_implementation_gap_2023_Asia.png",
       width = 180, height = 150, units = "mm", bg = "white", dpi = 600)
ggsave("figures/SUPP_FIGURE07_implementation_gap_2023_Asia.svg",
       width = 180, height = 150, units = "mm", bg = "white")
...
ggsave("figures/SUPP_FIGURE08_implementation_gap_2023_Australia.png",
       width = 180, height = 150, units = "mm", bg = "white", dpi = 600)
ggsave("figures/SUPP_FIGURE08_implementation_gap_2023_Australia.svg",
       width = 180, height = 150, units = "mm", bg = "white")
...
ggsave("figures/SUPP_FIGURE09_implementation_gap_2023_Europe.png",
       width = 180, height = 150, units = "mm", bg = "white", dpi = 600)
ggsave("figures/SUPP_FIGURE09_implementation_gap_2023_Europe.svg",
       width = 180, height = 150, units = "mm", bg = "white")
...
ggsave("figures/SUPP_FIGURE10_implementation_gap_2023_N_America.png",
       width = 180, height = 150, units = "mm", bg = "white", dpi = 600)
ggsave("figures/SUPP_FIGURE10_implementation_gap_2023_N_America.svg",
       width = 180, height = 150, units = "mm", bg = "white")

```

## SUPPLEMENRATY FIGURE 11: Project announcements and median 1.5°C scenario until 2050
...
p.added <- ggplot() +
  geom_col(data = data.plot.scenarios,
           ...
           alpha = 0.5) +
  scale_fill_manual(name = "1.5°C scenarios",
...
ggsave("figures/SUPP_FIGURE11_project_announcements_1.5C_median.png",
       width = 160, height = 60, units = "mm", bg = "white", dpi = 600)
ggsave("figures/SUPP_FIGURE11_project_announcements_1.5C_median.svg",
       width = 160, height = 60, units = "mm", bg = "white")

```

## SUPPLEMENTARY FIGURE 12: Technological learning for electrolysis
...
ggsave("figures/SUPP_FIGURE12_technological_learning.png",
       width = 160, height = 60, units = "mm", bg = "white", dpi = 600)
ggsave("figures/SUPP_FIGURE12_technological_learning.svg",
       width = 160, height = 60, units = "mm", bg = "white")

```

## SUPPLEMENTARY FIGURE 13: Green hydrogen in 1.5°C scenario under IEA NZE end-use shares

```{r supplementary figure 13}
...
# and afterwards according to median of 1.5°C scenarios
...
p.right <- ggplot() +
  ...
  scale_x_continuous(name = "Year") +
  ylab("Capacity (GW)") +
  ggtitle("Green hydrogen in median 1.5°C scenario with IEA NZE end-use shares")
...
ggsave("figures/SUPP_FIGURE13_iea_nze_enduse.png",
       width = 180, height = 80, units = "mm", bg = "white", dpi = 600)
ggsave("figures/SUPP_FIGURE13_iea_nze_enduse.svg",
       width = 180, height = 80, units = "mm", bg = "white")

```

## SUPPLEMENTARY FIGURE 14: Number of end-uses of green hydrogen projects
...
ggsave("figures/SUPP_FIGURE14_enduse_numbers.png",
       width = 100, height = 60, units = "mm", bg = "white", dpi = 600)
ggsave("figures/SUPP_FIGURE14_enduse_numbers.svg",
       width = 100, height = 60, units = "mm", bg = "white")

```

## SUPPLEMENTARY FIGURE 15: End-use specific demand-side regulation

```{r supplementary figure 15}
...
ggsave("figures/SUPP_FIGURE15_demand_regulation_by_enduse.png",
       width = 180, height = 120, units = "mm", bg = "white", dpi = 600)
ggsave("figures/SUPP_FIGURE15_demand_regulation_by_enduse.svg",
       width = 180, height = 120, units = "mm", bg = "white")

```

## SUPPLEMENTARY FIGURE 16: Required subsidies for 1.5°C scenario median

```{r supplementary figure 16}

# Conservative scenario
p.conservative.woco2 <- plotRequiredSubsidies1.5Cmedian(
  scenario.select = "Conservative",
  carbonprice.select = FALSE,
  title = "Required subsidies for 1.5°C scenario median\n(conservative)")
...
ggsave("figures/SUPP_FIGURE16_subsidies_1.5C.png",
       width = 180, height = 180, units = "mm", bg = "white", dpi = 600)
ggsave("figures/SUPP_FIGURE16_subsidies_1.5C.svg",
       width = 180, height = 180, units = "mm", bg = "white")

```

## SUPPLEMENTARY FIGURE 17: Capacity backed by announced subsidies and demand-side regulation
...
ggsave("figures/SUPP_FIGURE17_capacity_supported_by_policies.png",
       width = 120, height = 80, units = "mm", bg = "white", dpi = 600)
ggsave("figures/SUPP_FIGURE17_capacity_supported_by_policies.svg",
...
## SUPPLEMENTARY TABLE 1: Number of validated projects
